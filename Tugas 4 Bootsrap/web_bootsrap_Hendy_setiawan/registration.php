  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="" method="POST">
        ...
        <div class="form-group">
          <input type="text" name="username" id="name" class="form-control form-control-user" placeholder="Username Anda" required autocomplete="of">
        </div>
        <div class="form-group">
          <input type="email" name="email" id="name" class="form-control form-control-user" placeholder="Email Anda" required autocomplete="of">
        </div>
        <div class="form-group">
          <input type="password" name="password" class="form-control form-control-user" placeholder="Password Anda" required autocomplete="of">
        </div>
        ...
        <div class="input-group mt-3">
        <textarea class="form-control" aria-label="With textarea" name="biografi"></textarea>
        </div>

        <button type="submit" class="btn btn-success mt-3" name="submit">Tambah</button>
      </form>
    </div>

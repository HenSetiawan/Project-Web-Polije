              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form action="berhasil.php" method="post">
                      ...
                      <div class="form-group">
                          <b>Tanggal Lahir</b>
                          <input type="date" name="tl" id="tl" class="form-control form-control-user" placeholder="Tanggal Lahir" required>
                      </div>
                      <div class="form-group">
                          <b>Agama</b>
                          <select name="agama" id="agama" class="form-control form-control-user" placeholder="Agama">

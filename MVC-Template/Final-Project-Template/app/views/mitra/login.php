            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <img src="../public/image/logo2.png" style="height:500px;">
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                         ...
                         <form class="user"  action="<?=BASEURL?>/mitra/loginMitra" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary btn-user btn-block" name="submitmitra">Login</button>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?=BASEURL ?>/mitra/ForgotPassword">Forgot Password?</a>
                            </div>
                        </div>
                    </div>
                </div>
